...
const NodeMailer = (contentNodeMailer) => {
    var _a, _b;
    var emailDesconexao = ` <td class="container">
  <div class="content">
          ...
          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <div style="width:100px;max-width: 100px;">
                ...
                <br/>
                <br/>
                <p>Olá <strong>` + ((_a = contentNodeMailer.content) === null || _a === void 0 ? void 0 : _a.nameCompany) +
        `</strong>,</p>
                <p>A sua conexão <strong>` + ((_b = contentNodeMailer.content) === null || _b === void 0 ? void 0 : _b.nameConnection) +
    ...
    var emailNewCompany = ` <td class="container">
<div class="content">
  <!-- START CENTERED WHITE CONTAINER -->
  <table role="presentation" class="main">
    <!-- START MAIN CONTENT AREA -->
  ...
  <div class="footer">
    ...
    const emailMountContent = (content, subject) => {
        return (`<!doctype html>
    <html>
    <head>
    ...
    function main() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`Enviando Mensagem para a empresa ${contentNodeMailer.sentNameTo}.`);
            ...
            switch (contentNodeMailer.emailContent) {
                case "disconnect":
                    emailBody = emailMountContent(emailDesconexao, "Veja o que aconteceu e evite perder Atendimentos!");
                    ...
                    break;
                case "newCompany":
                    emailBody = emailMountContent(emailNewCompany, "Seja bem vindo(a) ao AtendimentoWhats!");
                    emailContentText.subject =
